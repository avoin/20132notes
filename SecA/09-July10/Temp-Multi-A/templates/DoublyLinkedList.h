...
class DoublyLinkedList : public Singleton<DoublyLinkedList<T>>
   {
   private:
      DLLNode<T>* front;
      DLLNode<T>* back;
   ...
   public:
      ...
      DoublyLinkedList& operator=(const DoublyLinkedList<T>& a)
         {
         auto c = a.front;
